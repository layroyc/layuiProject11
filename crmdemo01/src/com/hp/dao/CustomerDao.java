...
//        customer.setCust_name("是多少");
//        customer.setCust_company("地方");
//        customer.setCust_position("代表");
//        customer.setCust_phone("14785236932");
//        customer.setCust_birth("2000-11-08");
//        customer.setCust_sex(1);
//        customer.setCust_desc("沙发等各环节");
//        customer.setUser_id(9);
//        customer.setCreate_time("2000-11-08");
//        customer.setModify_time("2000-11-08");
//        int a=customerDao.insertCustomer(customer);
//        System.out.println("a = " + a);
            int a=customerDao.deleteByCustomerId(22);
            System.out.println("a = " + a);
